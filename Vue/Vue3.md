...
v-modal 只是语法糖。类似 vue2 中的.sync 操作符。
...
- defineCustomElement: 创建 web-components，和 defineComponent 接受的参数相同。注意需要配置 app.config.compilerOptions.isCustomElement 选项
...
从 Store 中解构也会丢失响应性，需要使用 storeToRefs()转化。
